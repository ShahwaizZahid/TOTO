...
class Restaurant  extends ChangeNotifier{
  List<Food> _menu = [
    ...
    Food(
      ...
      description: 'A premium cheeseburger with double beef patties, cheddar cheese, and fresh toppings.',
      imagePath: 'assets/images/burgers/cheese_burger.jpeg', // Changed image path to JPEG
    ...
    Food(
      ...
      description: 'A hot and spicy patti burger with jalapenos and tangy hot sauce.',
      imagePath: 'assets/images/burgers/pati_burger.jpeg', // Changed to JPEG format
    ...
    Food(
      ...
      description: 'A juicy beef burger topped with a sunny-side-up egg and fresh veggies.',
    ...
    Food(
      ...
      description: 'A crispy chicken zinger burger with fresh lettuce and spicy mayo.',
    ...
    Food(
      ...
      description: 'A massive burger loaded with bacon, cheese, and caramelized onions.',
      imagePath: 'assets/images/burgers/loaded_burger.jpeg', // Updated image path
  ...
  imagePath: 'assets/images/salads/caesar_salad.jpeg', // Update with the correct image path
  price: 7.99,
  availableAddons: [
  ...
  imagePath: 'assets/images/salads/cobb_salad.jpeg', // Update with the correct image path
  price: 9.49,
  availableAddons: [
  ...
  imagePath: 'assets/images/salads/greek_salad.jpeg', // Update with the correct image path
  price: 8.99,
  availableAddons: [
  ...
  imagePath: 'assets/images/salads/waldorf_salad.jpeg', // Update with the correct image path
  price: 7.49,
  availableAddons: [
  ...
  imagePath: 'assets/images/desserts/cheesecake_dessert.jpeg', // Update with the correct image path
  price: 4.99,
  availableAddons: [
  ...
  imagePath: 'assets/images/desserts/tiramisu_dessert.jpeg', // Update with the correct image path
  price: 5.49,
  availableAddons: [
  ...
  imagePath: 'assets/images/desserts/brownie_dessert.jpeg', // Update with the correct image path
  price: 3.99,
  availableAddons: [
  ...
  imagePath: 'assets/images/desserts/panna_cotta_dessert.jpeg', // Update with the correct image path
  price: 4.49,
  availableAddons: [
  ...
  imagePath: 'assets/images/desserts/eclair_dessert.jpeg', // Update with the correct image path
  price: 3.49,
  availableAddons: [
  ...
  imagePath: 'assets/images/sides/garlic_bread_side.jpeg', // Update with the correct image path
  price: 3.49,
  availableAddons: [
  ...
  imagePath: 'assets/images/sides/mashed_potatoes_side.jpeg', // Update with the correct image path
  price: 4.29,
  availableAddons: [
  ...
  imagePath: 'assets/images/sides/coleslaw_side.jpeg', // Update with the correct image path
  price: 2.99,
  availableAddons: [
  Addon(name: 'Extra Dressing', price: 0.50),
  ...
  imagePath: 'assets/images/sides/roasted_vegetables_side.jpeg', // Update with the correct image path
  price: 4.99,
  availableAddons: [
  ...
  imagePath: 'assets/images/sides/french_fries_side.jpeg', // Update with the correct image path
  price: 3.49,
  availableAddons: [
  ...
  imagePath: 'assets/images/drinks/lemonade_drink.jpeg', // Update with the correct image path
  price: 2.99,
  availableAddons: [
  ...
  imagePath: 'assets/images/drinks/iced_tea_drink.jpeg', // Update with the correct image path
  price: 2.49,
  availableAddons: [
  ...
  imagePath: 'assets/images/drinks/mojito_drink.jpeg', // Update with the correct image path
  price: 4.99,
  availableAddons: [
  ...
  imagePath: 'assets/images/drinks/smoothie_drink.jpeg', // Update with the correct image path
  price: 3.99,
  availableAddons: [
  ...
  imagePath: 'assets/images/drinks/espresso_drink.jpeg', // Update with the correct image path
  price: 2.49,
  availableAddons: [
